...
==================================
Относительно задания список доступных валют расширен до 21 валюты по списку отсюда https://index.minfin.com.ua/reference/currency/code/, и может быть легко расширен на весь список (в файле config хранится улучшенный словарь и заготовка для его расширения)
